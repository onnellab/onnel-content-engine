...
""",
            ...
            self.assertIn('<details class="credential-panel" aria-label="Automated posting credentials" open>', html)
            ...
            self.assertIn('<details class="tool-panel" aria-label="Publish controls" open>', html)
