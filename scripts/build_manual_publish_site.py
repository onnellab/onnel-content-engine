...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .empty {{ border: 1px dashed var(--line); padding: 28px; color: var(--muted); background: var(--panel); text-align: center; border-radius: 8px; }}
...
<body>
  ...
  <script>
    ...
    function card(item) {{
      ...
      actions.append(open, copy, doneButton);
      if (item.card_asset_href) {{
