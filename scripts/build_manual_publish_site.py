...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .platform-status summary {{ cursor: pointer; font-weight: 900; font-size: 16px; min-height: 44px; display: flex; align-items: center; }}
...
<body>
  ...
  <main>
    ...
    <details class="platform-status" aria-label="Platform status">
      <summary id="platform-status-title">매체별 상태</summary>
