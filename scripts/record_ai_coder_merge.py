...
def main() -> int:
    ...
    task.update({"status": "merged", "merged_by": args.approver, "merged_at": merged_at})
    ...
    items.append({"task_id": args.task_id, "repository": args.repository, "pr_number": args.pr_number, "approved_by": args.approver, "merged_at": merged_at})
