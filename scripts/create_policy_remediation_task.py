...
def main() -> int:
 p=argparse.ArgumentParser(); p.add_argument("task_id"); p.add_argument("--approver",required=True); p.add_argument("--confirm",action="store_true"); a=p.parse_args()
