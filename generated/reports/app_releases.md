...
Generated: 2026-09-25T10:35:48+09:00
...
| TagWeaver | android | 2.5.1 | 2.5.1 | same | updated | archived | onnellab/tagweaver | Create or verify release candidate |
| TagWeaver | ios | 2.5.0 | 2.5.1 | local_ahead | unchanged | planned | onnellab/tagweaver | Private test only; do not publish public GitHub Release |
...
| REL-0015 | TagWeaver | ios | private_test | v2.5.1 | planned | Private test; public Release disabled | - | - | 직접 추가한 파일을 상대 폴더, 로컬 검색, 경로 정렬, 빠른 색인과 수동 순서로 찾아보세요. 폴더를 접거나 펼치고, 저장 전에 변경 사항을 미리 보고 선택한 트랙 번호를 순서대로 적용할 수 있어요. | Private test only; do not publish public GitHub Release |
...
| --- | --- | --- | --- | --- |
| TagWeaver | android | updated | Create or verify release candidate | Version/update date read from Google Play public page; matching Android snapshot used as fallback metadata. Imported from github:onnellab/tagweaver/pubspec.yaml version 2.5.1+91; confirm against Play Console if needed. |
...
| TagWeaver | ios | planned | Private test only; do not publish public GitHub Release | Generated from repository build metadata because repository version is ahead of store snapshot. Store version: 2.5.0. Add release artifact and checksum only for private testing. Keep private until the version is publicly released. |
