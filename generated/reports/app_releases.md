...
| TagWeaver | ios | 2.5.0 | 2.5.1 | local_ahead | unchanged | archived | onnellab/tagweaver | Add release artifact and checksum |
...
| REL-0013 | TagWeaver | ios | public | v2.5.0 | archived | Archived | - | - | 직접 추가한 파일을 상대 폴더, 로컬 검색, 경로 정렬, 빠른 색인과 수동 순서로 찾아보세요. 폴더를 접거나 펼치고, 저장 전에 변경 사항을 미리 보고 선택한 트랙 번호를 순서대로 적용할 수 있어요. | No action |
...
| --- | --- | --- | --- | --- |
| TagWeaver | ios | unchanged | Add release artifact and checksum | - |
