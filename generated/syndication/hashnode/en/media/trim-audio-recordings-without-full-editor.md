...
Segra is a focused iOS and Android audio utility for trimming and organizing audio segments. It fits when the job is to isolate and arrange useful sections without opening a full audio-production application.
