...
- ID3.org: ID3v2.3.0 specification provides the earlier ID3v2.3 definitions relevant to files and tools that use that version.
- TagWeaver on the App Store is the official iOS product and platform listing.
- TagWeaver on Google Play is the official Android product and platform listing.
