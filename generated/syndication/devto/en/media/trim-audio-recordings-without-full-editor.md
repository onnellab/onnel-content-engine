...
![Audio trimming workflow](https://onnellab.com/blog-assets/en/trim-audio-recordings-without-full-editor/workflow-diagram.png "Backup-first workflow for selecting, previewing, exporting, and verifying an audio clip")
