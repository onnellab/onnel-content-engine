...
![Large TXT file reading workflow diagram](https://onnellab.com/blog-assets/en/read-large-txt-files-without-lag/workflow-diagram.png "Workflow diagram: file check, encoding check, reading mode, search, bookmarks, optional app")
...
This is the kind of workflow [VaultXT](https://onnellab.com/apps/vaultxt/) is built around: open the plain-text file first, then search, bookmark, or edit only when the task actually needs it.
...
Originally published at https://onnellab.com/blog/en/read-large-txt-files-without-lag/
