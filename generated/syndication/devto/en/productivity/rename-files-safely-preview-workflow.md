...
![Workflow diagram](https://onnellab.com/blog-assets/en/rename-files-safely-preview-workflow/workflow-diagram.png "Plan rules, inspect a preview, test a subset, and apply a batch rename")
